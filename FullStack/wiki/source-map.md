...
| Admin orders workspace extraction | `features/admin-dashboard/components/AdminOrdersWorkspace.tsx`, `features/admin-dashboard/components/OrderTable.tsx`, `features/admin-dashboard/components/AdminTabNav.tsx` | `app/admin-dashboard/page.tsx`, `components/SliceMaticStage3.tsx`, `components/admin/OrderContextPanel.tsx` | [[components]], [[architecture]], [[delivery-operations]] |
